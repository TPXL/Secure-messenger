...
public class MessagingFrame extends javax.swing.JFrame {
     ...
     */
    ClientToClientConnectionHandler clientToClientConnectionHandler;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            clientToClientConnectionHandler.sendMessagePacket(messageField.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessagingFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MessagingFrame().setVisible(true);
            }
        });
    }
